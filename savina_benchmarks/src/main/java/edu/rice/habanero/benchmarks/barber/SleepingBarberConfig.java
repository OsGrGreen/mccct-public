...
public final class SleepingBarberConfig {
    ...
    protected static int N = 5_00; // num haircuts
    protected static int W = 1_00; // waiting room size
    protected static int APR = 1_00; // average production rate
    protected static int AHR = 1_00; // avergae haircut rate
