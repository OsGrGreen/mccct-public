...
public final class GuidedSearchConfig {
    ...
    protected static final int PRIORITY_GRANULARITY = 4;
    protected static int NUM_WORKERS = 10;
    protected static int GRID_SIZE = 15;
    protected static int PRIORITIES = 15;
    protected static int THRESHOLD = 512;
