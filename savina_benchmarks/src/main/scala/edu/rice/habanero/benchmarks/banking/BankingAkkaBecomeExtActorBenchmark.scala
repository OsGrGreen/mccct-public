...
import org.apache.pekko.actor.{ActorRef, CustomStash, Props}
...
/** @author
  ...
  */
object BankingPekkoBecomeExtActorBenchmark {

  @main def BankingBecomeExtActor(args: String*) = {
    BenchmarkRunner.runBenchmark(args.toArray, new BankingPekkoBecomeExtActorBenchmark)
  }

  private final class BankingPekkoBecomeExtActorBenchmark extends Benchmark {
  ...
  protected class Account(id: Int, var balance: Double) extends PekkoActor[AnyRef] with CustomStash {
    ...
    override def process(theMsg: AnyRef) = {
      theMsg match {
        ...
        case cm: CreditMessage =>
          ...
          implicit val timeout: Timeout = Timeout(6000.seconds)
